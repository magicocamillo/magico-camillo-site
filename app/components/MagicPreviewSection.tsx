      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <div className="mx-auto mb-16 max-w-3xl text-center">
          ...
          <p className="mt-8 text-lg leading-8 text-white/70">
            ...
            Solo uno dei tanti momenti che il pubblico vive durante uno spettacolo di Magico Camillo.
          </p>
        ...
        <div className="relative overflow-hidden rounded-[32px] border border-[#d4af37]/20 shadow-2xl">
          ...
          {!started && (
            <button
              onClick={playVideo}
              className="absolute inset-0 flex flex-col items-center justify-center bg-black/45 hover:bg-black/35 transition"
            >
              <div className="flex h-24 w-24 items-center justify-center rounded-full border-2 border-[#d4af37] bg-black/50 text-5xl text-[#d4af37]">
                ▶
              </div>
