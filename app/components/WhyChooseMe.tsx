      ...
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto mb-16 max-w-3xl text-center">
          ...
          <p className="mt-8 text-lg leading-8 text-white/70">
            Ogni spettacolo nasce per coinvolgere tutta la famiglia, unendo
            comicità, magia, teatro e tecnologia in un&apos;esperienza elegante,
            divertente e ricca di emozioni.
          </p>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-2">
          {features.map((feature) => (
            ...
            >
              <div className="mb-6 h-px w-16 bg-[#d4af37]/60" />
